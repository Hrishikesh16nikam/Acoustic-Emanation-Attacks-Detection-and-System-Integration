function [pushPeak,clickRecognized, keys] = extractKeyStroke(fileName, maxClicks, threshold)
...
rawSound = audioread(fileName)';

% dropout first 550 sample points
rawSound = rawSound(1,fix(4400/8):size(rawSound,2));
